...
import org.mvel3.transpiler.util.CoercionUtils;
...
public class MapPutExprT implements TypedExpression {
    ...
    public Node toJavaExpression() {
        ...
        final Expression coercedValue = CoercionUtils.coerceMapValueToString(type, originalValue);

        return new MethodCallExpr((Expression) name.toJavaExpression(),
                                  CoercionUtils.PUT_CALL,
