...
import static org.mvel3.util.MethodUtils.getMethod;
...
public final class ClassUtils {
    ...
    public static Map<String, Integer> accessorPriorityMap(String field) {
        ...
        accessorPriorityMap.put("is" + StringUtils.ucFirst(field), 4);
        accessorPriorityMap.put("is" + field, 3);
        accessorPriorityMap.put("get" + StringUtils.ucFirst(field), 2);
