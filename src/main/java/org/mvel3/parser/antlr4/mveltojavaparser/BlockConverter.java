...
import org.mvel3.parser.antlr4.mveltojavaparser.tolerant.TolerantBlockConverter;
...
public final class BlockConverter {
    ...
    public static Node convertBlock(final Mvel3Parser.BlockContext ctx,
        ...
        if (mvel3toJavaParserVisitor.isTolerantMode()) {
            return TolerantBlockConverter.convertBlock(ctx, mvel3toJavaParserVisitor);
        } else {
    ...
    public static Node convertBlockStatement(final Mvel3Parser.BlockStatementContext ctx,
            final Mvel3ToJavaParserVisitor mvel3toJavaParserVisitor) {
        if (mvel3toJavaParserVisitor.isTolerantMode()) {
            return TolerantBlockConverter.convertBlockStatement(ctx, mvel3toJavaParserVisitor);
        } else {
