...
import org.mule.mvel2.integration.impl.*;
...
import static org.mule.mvel2.MVELRuntime.execute;
import static org.mule.mvel2.util.ParseTools.loadFromFile;
import static org.mule.mvel2.util.ParseTools.optimizeTree;
...
public class MVEL {
  ...
  public static void resetDefaultCompilerOpts() {
    ...
    COMPILER_OPT_PROPERTY_ACCESS_DOESNT_FAIL = getBoolean("mvel2.compiler.property_access_doesnt_fail");
  }
   ...
   * @param resolverFactory The instance of the VariableResolverFactory to be used.
   * @return The resultant value
   * @see #eval(String, org.mule.mvel2.integration.VariableResolverFactory)
   */
   ...
   * value.<br/>{@link org.mule.mvel2.integration.Interceptor Interceptors} are markers within an expression that allow external hooks
