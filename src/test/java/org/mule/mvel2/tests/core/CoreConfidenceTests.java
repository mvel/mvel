...
import org.mule.mvel2.integration.impl.IndexedVariableResolverFactory;
...
//  }
  ...
  public void testVarArgsParams() {
    ...
    assertEquals(String.format("null"),
                   runSingleTest("import org.mule.mvel2.tests.core.res.AStatic; a = null; AStatic.process(a)"));
    assertEquals(String.format("hello,world,"),
                   runSingleTest("import org.mule.mvel2.tests.core.res.AStatic; AStatic.process(\"hello\",\"world\")"));

      assertEquals(String.format(""),
                   runSingleTest("import org.mule.mvel2.tests.core.res.AStatic; AStatic.process()"));
      assertEquals(String.format("null"),
                   runSingleTest("import org.mule.mvel2.tests.core.res.AStatic; AStatic.process(null)"));
  ...
  public void testUnwantedImport() {
    ...
    conf.addPackageImport("org.mule.mvel2.tests.core.res");
